...
import { resetPasswordFromCookie } from '../actions';
...
export default function ResetPasswordUpdatePage() {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    const result = await resetPasswordFromCookie(formData);
    ...
    setState({
      status: 'error',
      message: 'Link resetu jest nieprawidłowy lub wygasł. Poproś o nowy link.',
    });
  }
